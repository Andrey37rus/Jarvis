...
from reproduction import play_music, up, down, next_trak, previous_track
...
chunk = {
    ...
    'запустить': ('запусти', 'запускай', 'запустить', 'включи', 'включить'),
...
words_arguments = ('выключить', 'закрыть', 'запустить')
